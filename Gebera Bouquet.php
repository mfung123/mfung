<!DOCTYPE html>
<head>
<body style="background-color:#FFE2B5"> 
...
<link rel="Stylesheet" type="Text/css" href="wedding.css" /></link>
...
<body> 
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="Gerbera1.png" alt="First slide">
    </div>
    <div class="carousel-item">
            <img class="d-block w-100" src="Gerbera2.png" alt="Second slide">
    </div>
    <div class="carousel-item">
           <img class="d-block w-100" src="GerberaTop1.png" alt="Third slide">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
			...
			<div class="col-md-7">
				...
				<h2>Gebera Bouquet<h2>
				<p>Product ID:BA-BO-403</p>
				<p class="price"><b>Price :</b>MYR 199.00</p>
				<p><b>Availability: </b>In Stock</p>
				<p><b>Condition: </b>New</p>
				<p><b>Brand: </b>Fairly Florist</p>
